...
import { deleteUser, getAuthorizeduser, getSingleUser, getUser, getUsersBankdetails, getUsersPFdetails, upsertUser, } from "../../controllers/HRMS/user.Controller.js";
import { getLeaveData, getLeavesByApprover, getLeavesByUsers, getSingleLeaves, upsertLeaves, } from "../../controllers/HRMS/leave.Controller.js";
import { getLeaveBalanceByUsers, upsertLeaveBalanceByUsers, } from "../../controllers/HRMS/leaveBalance.Controller.js";
import { getAttendanceDate, updateAttendance, upsertAttendance, getAttendanceByUserIdDate, updateAttendanceStatus, getsingleAttendance, upsertBulkAttendance, getAttendaceForMonthandYear, upsertAttendancetime, } from "../../controllers/HRMS/attendance.Controller.js";
import { deleteLoan, getLoans, getSingleLoan, upsertLoan, } from "../../controllers/HRMS/loan.Controller.js";
import { deleteJobApplicant, getAllJobApplicants, getSingleJobApplicant, upsertJobApplicant, } from "../../controllers/HRMS/jobApplicants.Controller.js";
import { cancelScheduledInterview, getAllScheduledInterviews, getScheduledInterviewById, upsertScheduledInterview, } from "../../controllers/HRMS/scheduleInterview.Controller.js";
import { deleteOnboardingData, getAllOnboardingData, getSingleOnboardingData, upsertOnboardingData, } from "../../controllers/HRMS/onBoarding.Controller.js";
...
import { getAllAttendanceRegularize, insertAttendanceRegularize, getAttendanceRegularizebyUser, updateAttendanceRegularize, getAttendanceRegularizebyId, } from "../../controllers/HRMS/attendanceRegularize.Controller.js";
import { deleteEightyCData, getAllEightyCData, getEightyCDataById, getEightyCDataByUserId, upsertEightyCData, } from "../../controllers/HRMS/eightyC.Controller.js";
...
import { deleteOtherChaptersData, getAllOtherChaptersData, getOtherChaptersDataByUserId, getSingleOtherChaptersData, upsertOtherChaptersData, } from "../../controllers/HRMS/otherChapters.Controller.js";
import { deleteHouseRentAllowanceData, getAllHouseRentAllowanceData, getHouseRentAllowanceDataByUserId, getSingleHouseRentAllowanceData, upsertHouseRentAllowanceData, } from "../../controllers/HRMS/houseRentAllowance.Controller.js";
// import { deleteBankDetails, getBankDetails, getIndividualBankDetails, upsertBankDetails } from "../../controllers/HRMS/bankDetails.Controller.js";
// import { deletePFDetails, getIndividualPFDetails, getPFDetails, upsertPFDetails } from "../../controllers/HRMS/pfDetails.controller.js";
...
import { getAllApprovals, getApprovalbyApprover, getApprovalsById, insertApprovals, updateApprovals, } from "../../controllers/HRMS/approval.Controller.js";
import { getAllMedicalSectionEightyDData, getMedicalSectionEightyDDataById, getMedicalSectionEightyDDataByUserId, upsertMedicalSectionEightyDData, deleteMedicalSectionEightyDData, } from "../../controllers/HRMS/medicalSectionEightyD.Controller.js";
import { getAllIncomeLossHousePropertiesData, getSingleIncomeLossHousePropertiesData, getIncomeLossHousePropertiesDataByUserId, upsertIncomeLossHousePropertiesData, deleteIncomeLossHousePropertiesData, } from "../../controllers/HRMS/incomeLossHouseProperties.Controller.js";
import { deleteOtherIncomeData, getAllOtherIncomeData, getOtherIncomeDataByUserId, getSingleOtherIncomeData, upsertOtherIncomeData, } from "../../controllers/HRMS/otherIncome.Controller.js";
import authVerify from "../../auth/auth.js";
import { deleteDeclaredTaxAmountData, getAllDeclaredTaxAmountData, getDeclaredTaxAmountDataByUserId, getSingleDeclaredTaxAmountData, upsertDeclaredTaxAmountData, } from "../../controllers/HRMS/declaredTaxAmount.Controller.js";
import { generateBulkPaySlipData, generateBulkPayslip, getAllPaySlipData, getPaySlip, getPayslipByUserMonth, } from "../../controllers/HRMS/payslip.Controller.js";
...
import { excelGenearator, getTimeSheet, getTimeSheetForMonthandYear, getTimeSheetbydateanduser, upsertTimeSheet, } from "../../controllers/HRMS/timeSheet.controller.js";
const Routes = function (fastify, opts, done) {
    //Authentication
    ...
    fastify.get("/attendance-regularize/user/:userId", getAttendanceRegularizebyUser);
    ...
    fastify.get("/house-rent-allowance/user/:userId", getHouseRentAllowanceDataByUserId);
    ...
    fastify.get("/medical-section-eightyd/user/:userId", getMedicalSectionEightyDDataByUserId);
    fastify.delete("/medical-section-eightyd/:id", deleteMedicalSectionEightyDData);
    //incomeLossHouseProperties
    fastify.post("/income-loss-house-properties", upsertIncomeLossHousePropertiesData);
    fastify.get("/income-loss-house-properties", getAllIncomeLossHousePropertiesData);
    fastify.get("/income-loss-house-properties/:id", getSingleIncomeLossHousePropertiesData);
    fastify.get("/income-loss-house-properties/user/:userId", getIncomeLossHousePropertiesDataByUserId);
    fastify.delete("/income-loss-house-properties/:id", deleteIncomeLossHousePropertiesData);
    // otherIncome
    ...
    fastify.get("/declaredTaxAmount/user/:userId", getDeclaredTaxAmountDataByUserId);
    fastify.delete("/declaredTaxAmount/:id", deleteDeclaredTaxAmountData);
    done();
};
export default Routes;
//# sourceMappingURL=routeshrms.js.map