...
(function (leaveService) {
    async function getLeaves() {
        try {
            ...
            const result = await query("SELECT * FROM leaves", []);
    ...
    async function upsertLeaves(request) {
        try {
    ...
    async function getLeavesByUsers(userId) {
        try {
            ...
            const result = await query("SELECT * FROM leaves WHERE userId = $1", [userId]);
            console.log(result.rows, "query results");
            return result.rows;
        }
        catch (error) {
    ...
    async function getLeavesByApprover(approverId) {
        try {
            ...
            console.log(params);
            const result = await query(innerQuery, params);
            console.log(result.rows, "query results");
            return result.rows;
        }
        catch (error) {
    ...
    async function getLeavesByUsersQuery(userId, reqQuery) {
    ...
    leaveService.getLeavesByUsersQuery = getLeavesByUsersQuery;
    async function getLeavesByUsersExcludePending(userId, reqQuery) {
    ...
    leaveService.getLeavesByUsersExcludePending = getLeavesByUsersExcludePending;
