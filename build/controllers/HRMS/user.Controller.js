...
export const getUsersBankdetails = async (request, reply) => {
    try {
...
export const getUsersPFdetails = async (request, reply) => {
    try {
        console.log(request.params, "request");
...
export const getUsersMedicalInsurence = async (request, reply) => {
    try {
        console.log(request.params, "request");
